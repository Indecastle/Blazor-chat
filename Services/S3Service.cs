...
namespace Chat.Services
{
    public class S3Service : IS3Service
    {
        ...
        public S3Service(IAmazonS3 client, ILogger<S3Service> logger, string bucketName = "itra-task03", bool isTest = false)
        {
            IsTest = isTest;
            _logger = logger;
            _client = client;
            _client = new AmazonS3Client(@"AKIAJ7L5HULDRF5AE75A", @"ScBKLT/kolr8EuEIzNCFsi6eaWwMntXrkOzDlk7A", RegionEndpoint.EUCentral1);
